...
public class Feedback extends JFrame {
	...
	public Feedback() {
		...
		btnNewButton_1_1.setIcon(new ImageIcon(Feedback.class.getResource("/icones/Fechar.png")));
		...
		btnNewButton.setIcon(new ImageIcon(Feedback.class.getResource("/icones/Button (1).png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(Feedback.class.getResource("/icones/Mostrar.png")));
		...
		btnLimpar.setIcon(new ImageIcon(Feedback.class.getResource("/icones/Limpar.png")));
