...
public class Janela extends JFrame {
	...
	public Janela() {
		...
		btnAlterar.setIcon(new ImageIcon(Janela.class.getResource("/icones/Alterar.png")));
		...
		btnexcluir.setIcon(new ImageIcon(Janela.class.getResource("/icones/Excluir.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(Janela.class.getResource("/icones/FeedBack.png")));
		...
		btnNewButton.setIcon(new ImageIcon(Janela.class.getResource("/icones/Button.png")));
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(11)
							.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 1003, Short.MAX_VALUE))
						.addGroup(gl_contentPane.createSequentialGroup()
