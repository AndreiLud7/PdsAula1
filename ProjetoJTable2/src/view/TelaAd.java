...
public class TelaAd extends JFrame {
	...
	public TelaAd(Janela janela) {
		...
		JLabel lblNewLabel = new JLabel("Nome do Hospede");
		
		JLabel lblNewLabel_1 = new JLabel("Numero Quarto");
		
		JLabel lblNewLabel_2 = new JLabel("Data do Consumo");
		
		JLabel lblNewLabel_3 = new JLabel("Descrição do Item");
		
		JLabel lblNewLabel_3_1 = new JLabel("Quantidade Consumida");
		
		JLabel lblUnitario = new JLabel("Custo Unitario");
		
		JLabel lblNewLabel_1_1 = new JLabel("Custo total Item");
		
		JLabel lblNewLabel_2_1 = new JLabel("Pago até o momento");
		
		JLabel lblNewLabel_3_2 = new JLabel("Metodo de Pagamento");
		
		JLabel lblNewLabel_3_1_1 = new JLabel("Hora consumida");
		
		JLabel lblNewLabel_3_2_1 = new JLabel("Funcionario Responsavel");
		...
		btnNewButton.setIcon(new ImageIcon(TelaAd.class.getResource("/icones/Button.png")));
...
//---------------------------
			...
			else if(!nometxt.getText().matches("[a -z A -Z ]+")) {
			...
			else if(!responsaveltxt.getText().matches("[a -z A -Z ]+")) {
		...
		btnNewButton_1.setIcon(new ImageIcon(TelaAd.class.getResource("/icones/Fechar.png")));
		...
		btnNewButton_2.setIcon(new ImageIcon(TelaAd.class.getResource("/icones/Limpar.png")));
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addContainerGap()
							.addComponent(btnNewButton, GroupLayout.PREFERRED_SIZE, 145, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)))
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(29)
							.addComponent(btnNewButton_2, GroupLayout.PREFERRED_SIZE, 110, Short.MAX_VALUE))
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
							.addComponent(hctxt, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
							.addComponent(comboBox, Alignment.LEADING, 0, 168, Short.MAX_VALUE)
							.addComponent(totaltxt, GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
							.addComponent(nometxt, GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
							.addComponent(quantidadetxt, GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
							.addComponent(Datatxt, GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)))
					.addGap(39)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(lblNewLabel_2_1, GroupLayout.PREFERRED_SIZE, 125, GroupLayout.PREFERRED_SIZE))
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGap(12)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addComponent(quartotxt, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
								.addComponent(desctext, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(btnNewButton_1, GroupLayout.PREFERRED_SIZE, 130, Short.MAX_VALUE)
							.addGap(116)))
					.addContainerGap())
		);
